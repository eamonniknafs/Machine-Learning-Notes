...
![[Pasted image 20221018150715.png|600]]
### Notation
...
![[Pasted image 20221021191608.png|600]]
![[Pasted image 20221021191633.png|600]]

## 2-dimensional parameters
![[Pasted image 20221021191728.png|400]]![[Pasted image 20221021191740.png|400]]
## Gradient Descent for Least Squares Cost
![[Pasted image 20221021192115.png|600]]
...
![[Pasted image 20221022150135.png|600]]
...
![[Pasted image 20221022151635.png|200]]
...
![[Pasted image 20221022162452.png|600]]
# Trade-offs
...
![[Pasted image 20221022164801.png|300]]
### Hypothesis
$h_\theta(x)=\theta^Tx$
$\theta$: Parameters
$D=(x^{(i)}, y^{(i)}):$ data
...
![[Pasted image 20221022164907.png|400]]

## Alternative view: Maximum Likelihood
![[Pasted image 20221022165006.png|400]]

## Maximum Likelihood: Coin Toss Example
![[869C46E2-BDF2-4A6D-8715-FBFDA5AD16AB copy.jpg]]
...
![[Pasted image 20221022174806.png|600]]
...
![[Pasted image 20221022170625.png|600]]
...
![[Pasted image 20221022183830.png|600]]
...
![[Pasted image 20221022194803.png|600]]
...
![[Pasted image 20221022195253.png|400]]

# Predictive Distribution
Given a new input point $x$, we can now compute a distribution over the output $t$:
![[79E5AFF7-0F8C-41B3-A7AD-F26AB1714528 copy.jpg|400]]

# Non-linear Features
### Example
![[Pasted image 20221022195704.png|600]]
$t=5e^x+2+noise$
	$h=28x-9$
change this to:
$t=5z+2+noise$
...
![[Pasted image 20221022200116.png|600]]
![[Pasted image 20221022200129.png|600]]
...
![[Pasted image 20221023131531.png|600]]

### Another Example
#### How to transform the input/feature?
![[Pasted image 20221023131646.png|300]]
...
![[Pasted image 20221022200916.png|600]]
...
# Overfitting
![[Pasted image 20221022200159.png|600]]

A disaster in overfitting:
![[Pasted image 20221022200245.png|600]]
...
![[Pasted image 20221022200405.png|300]]
...
- Basic ideas
	- Use more training data
		  ![[Pasted image 20221022200608.png|400]]
	- 
